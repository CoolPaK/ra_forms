    ...
    return(
        <form className="stepsForm" onSubmit={onSubmit}>
            <div>
                ...
                <input className={dateClass} type="text" onChange={onChangeDate} value={date} placeholder="04.02.1990 = 04021990" />
            </div>
            <div>
                <div>Пройдено км</div>
                <input className={distanceClass} type="text" onChange={onChangeDistance} value={distance} placeholder="1.0" />
            </div>            
